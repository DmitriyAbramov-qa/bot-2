...
bot = TeleBot(token='6648803897:AAH2R2upbharcJJXGN_b2Cw7pXfHBMydKwQ', parse_mode='html') # создание бота
...
DEFINITOINS = {
    ...
    'git': 'технология облачного хранилища кодов',
    'смоук': 'частичная проверка сайта, приложения на то, что новый функционал не сломал старый',
    'техники тест дизайна': 'тест-дизайна - это метод позволяющий сократить количество проверок'
}
